          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              {user ? (
                ...
                <button onClick={openAuthModal} className="flex items-center gap-1 text-gray-700 hover:text-blue-600 transition">
                  <User size={16} /> Login
                </button>
              )}
            </div>
            ...
            <div className="md:hidden">
              <button onClick={toggleMenu} className="text-gray-700 hover:text-blue-600 p-2 rounded-md transition">
            ...
            <div className="md:hidden border-t border-gray-100 bg-white">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  >
                    <span>Vote</span>
                    <ChevronDown className={`w-4 h-4 transition-transform ${isMobileVoteOpen ? 'rotate-180' : ''}`} />
                  </button>
                  {isMobileVoteOpen && (
                    <>

      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="grid lg:grid-cols-12 gap-8 items-center min-h-[80vh]">
          <div className="lg:col-span-7 text-center lg:text-left">
            <div className="inline-flex items-center px-4 py-2 bg-blue-500/20 rounded-full text-blue-100 text-sm font-medium mb-6 backdrop-blur-sm border border-blue-400/20">
            ...
            <p className="text-lg text-blue-100 mb-8 leading-relaxed max-w-xl">
              Your voice matters in shaping the future of Nudom School of Business & Technology. 
              Participate in the SRC 2025 Elections and make your vote count.
            </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">Advanced security measures protect your vote</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">Open and verifiable election process</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">Distributed system for fair elections</p>
                  </div>
                </div>
              </div>
            </div>
